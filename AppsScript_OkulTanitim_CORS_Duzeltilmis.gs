...
function seedDefaults_() {
  ...
  if (rooms.getLastRow() < 2) rooms.getRange(2,1,3,3).setValues([
    ['oxford','Oxford Görüşme Odası',true],
    ['cambridge','Cambridge Görüşme Odası',true],
    ['anaokulu','Anaokulu Tanıtım Birimi',true]
  ]);
...
function formatDate_(v) { if (!v) return ''; if (Object.prototype.toString.call(v) === '[object Date]') return Utilities.formatDate(v, TZ, 'yyyy-MM-dd'); return String(v).substring(0,10); }
